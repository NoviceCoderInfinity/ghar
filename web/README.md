...
**Fork Origin/Note:** This is an adaptation of Google's official Live API web console starter (`https://github.com/google-gemini/live-api-web-console`), customized and extended as part of the Ghar live multimodal interior designer application.
